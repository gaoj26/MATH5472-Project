...
%% synthesize of documents/images
image_synthesis;

%% run Gibbs sampling
[est_Phi, est_Theta, est_z, logPw_z, Phi_iter]=GibbsLDA_sampler(w, K, 1, 1, 200, 150, 5);

%% visualize learned topics in different iterations
figure; colormap 'gray'
for iter=1:200
    if (mod(iter,10)==0) % visualize estimated topics every 10 iterations
        for k=1:8
